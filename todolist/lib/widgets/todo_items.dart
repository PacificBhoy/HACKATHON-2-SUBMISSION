      ...
      child: ListTile(
        ...
        trailing: Container(
          ...
          decoration: BoxDecoration(
            color: const Color.fromARGB(255, 216, 80, 71),  // Set background color of the delete button container to red
          ...
          child: IconButton(
            ...
            icon: Icon(
              Icons.delete,
              size: 18,
              color: Color.fromARGB(255, 251, 253, 252),  // Set icon color to white
            ),
          ),
        ),
      ),
